package behavioral.iteratorPattern.anotherExample.test;

import static behavioral.iteratorPattern.anotherExample.model.ChannelCollection.ChannelTypeEnum.KANNADA;
import static behavioral.iteratorPattern.anotherExample.model.ChannelCollection.ChannelTypeEnum.ENGLISH;
import static behavioral.iteratorPattern.anotherExample.model.ChannelCollection.ChannelTypeEnum.HINDI;
import static behavioral.iteratorPattern.anotherExample.model.ChannelCollection.ChannelTypeEnum.ALL;
import static behavioral.iteratorPattern.anotherExample.model.ChannelCollection.ChannelTypeEnum.NONE;

import behavioral.iteratorPattern.anotherExample.model.Channel;
import behavioral.iteratorPattern.anotherExample.model.ChannelCollection;
import behavioral.iteratorPattern.anotherExample.model.ChannelCollectionImpl;
import behavioral.iteratorPattern.anotherExample.model.ChannelIterator;
...
public class ChannelIteratorTest {
	...
	public static void main(String[] args)
	{
		...
		final ChannelCollection collection = new ChannelCollectionImpl();
		...
		ChannelIterator iterator = collection.iterator(KANNADA);
